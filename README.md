...
Spec: [words-XML v1.2.0](https://github.com/rachmanzz/docx-preprocessor/blob/main/docx-preprosessor.md)
...
```xml
<words xmlns="urn:words:v1" version="1.2.0" mode="semantic" fidelity="verbatim" policy="preserve-and-flag">
  <style unit="in">
